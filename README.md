...
This extension is the English version of the [French repository](https://github.com/gael-thomas/Mentor-Statistics-OpenClassRooms) created by [gael-thomas](https://github.com/gael-thomas).
...
Once you have downloaded the extension, when you go on [the mentorship sessions history](https://openclassrooms.com/en/mentorship/dashboard/mentorship-sessions-history), a new table appear and the information start to appear.
...
For the versions available, see the [tags on this repository](https://github.com/bapspatil/Mentor-Statistics-OpenClassrooms/tags).

## Authors

- **Gaël THOMAS** - _Initial work_ - [gael-thomas](https://github.com/gael-thomas)
- **Bapusaheb Patil** - _Conversion to English for non-French Mentors_ - [bapspatil](https://bapspatil.com)
